...
export const aiModels: Model[] = [
  ...
  { id: 'deepseek-ai/deepseek-v4-flash', name: 'DeepSeek V4 flash', provider: 'DeepSeek', backend: 'puter' },
  ...
  { id: 'minimaxai/minimax-m2.7', name: 'minimax-m2.7', provider: 'minimax', backend: 'nvidia' },
